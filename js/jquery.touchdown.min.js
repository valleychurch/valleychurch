...
/**
* Additions by Rick Butterfield, related to how list items are indented on the select.
* Plus some fixes for iOS where selecting a disabled menu item would cause the browser to try and go to a page that doesn't exist
*/
        ...
        return this.each(function () {
            ...
            for (var i = 0; i < anchor.length; i++) {
                ...
                if (a.attr('href') != null) {
                    ...
                    optionList += '<option disabled="disabled" value="' + window.location.href + '">' + indent + ' ' + a.text() + '</option>';
                }
